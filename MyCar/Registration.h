...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(197, 128);
			...
			this->button4->Text = L"Вернуться в меню";
			...
			this->оПрограммеToolStripMenuItem->Click += gcnew System::EventHandler(this, &Registration::оПрограммеToolStripMenuItem_Click);
			// 
			// label4
			// 
			...
			this->выходToolStripMenuItem->Click += gcnew System::EventHandler(this, &Registration::выходToolStripMenuItem_Click);
			// 
			...
			this->потвердитьToolStripMenuItem->Click += gcnew System::EventHandler(this, &Registration::потвердитьToolStripMenuItem_Click);
			// 
			// button3
			// 
			...
			this->регистрацияToolStripMenuItem->Size = System::Drawing::Size(53, 20);
			this->регистрацияToolStripMenuItem->Text = L"Меню";
			this->регистрацияToolStripMenuItem->Click += gcnew System::EventHandler(this, &Registration::регистрацияToolStripMenuItem_Click);
			// 
			// Registration
			// 
			...
			this->Text = L"ROADliteLiesing  v. 2.4 - Registration";
...
private: System::Void потвердитьToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e);
